...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  const targetGender = starWarsCharacters[i].gender
  if (targetGender === "female") { femaleCharacters.push(targetCharacter) };
}
...
let crewMass = 0
let i = 0
while (i < starWarsCharacters.lemngth) {
...
if (crewMass > 0 && crewMass < 700) { console.log("Ship is under loaded") }
else if (crewMass > 0 && crewMass < 700) { console.log("Ship is half loaded") }
...
else { console.log("Wrong Data Provided") }
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "n/a") { starWarsCharacters[i].gender === "androids" };
}
